...
class DataService {
    ...
    func getAllFeedMessages(handler: @escaping (_ messages: [Message]) -> ()) {
        ...
        REF_FEED.observeSingleEvent(of: .value) { (feedMessageSnapshopt) in
            guard let feedMessageSnapshopt = feedMessageSnapshopt.children.allObjects as? [DataSnapshot] else { return }
            for message in feedMessageSnapshopt {
